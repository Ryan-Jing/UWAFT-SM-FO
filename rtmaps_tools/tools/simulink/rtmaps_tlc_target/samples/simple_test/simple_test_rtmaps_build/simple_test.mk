...
MODEL                = simple_test
MODULES              = maps_simple_test.cpp simple_test_data.cpp rt_cppclass_main.cpp
MAKEFILE             = simple_test.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2025b
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2025b
MATLAB_BIN           = C:\Program Files\MATLAB\R2025b\bin
ALT_MATLAB_BIN       = C:\PROGRA~1\MATLAB\R2025b\bin
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\PROGRA~1\INTEMP~1\RTMAPS~1\tools\simulink\RTMAPS~3\samples\SIMPLE~1
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = C:\PROGRA~1\INTEMP~1\RTMAPS~1\sdk\VC0007~1.NET\lib\RTMAPS~4.LIB
NUMST                = 1
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  DISPLAY_OPTIM_OPTIONS=0 INTEGER_CODE="0" GENERATE_ERT_S_FUNCTION="0" RTMAPS_SDKDIR="C:\Program Files\Intempora\RTMaps 4" RTMAPS_OS="vc.net2022" RTMAPS_ARCH="x86_64" RTMAPS_BOARD="vc.net2022_x64" INCLUDE_MDL_TERMINATE_FCN=1 OPTS="-DTID01EQ=0 /MD /TP /INCLUDE:MAPSPckInit /INCLUDE:MAPSGetModulesDefStruct"
MULTITASKING         = 0
MAT_FILE             = 0
EXT_MODE             = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simple_test_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\simple_test_rtmaps_build
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\simulink\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~1\INTEMP~1\RTMAPS~1\sdk\VC0007~1.NET\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~1\INTEMP~1\RTMAPS~1\packages\RTC572~1\include
...
rt_cppclass_main.obj : $(MATLAB_ROOT)\rtw\c\src\common\rt_cppclass_main.cpp
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\src\common\rt_cppclass_main.cpp
	$(CC) $(CPPFLAGS) $(MATLAB_ROOT)\rtw\c\src\common\rt_cppclass_main.cpp
