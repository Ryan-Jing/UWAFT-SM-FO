#ifndef maps_simple_test_h_
#define maps_simple_test_h_
#ifdef _MSC_VER
#if _MSC_VER < 1900
...
#define ComponentClass                 maps_simple_test
#define ComponentName                  "simple_test"
#define ComponentVersion               "1.0"
