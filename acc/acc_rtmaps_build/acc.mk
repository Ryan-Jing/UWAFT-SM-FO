...
MODEL                = acc
MODULES              = acc_rtmaps_tlc_types.cpp maps_acc.cpp maps_acc_merger.cpp maps_acc_splitter.cpp rt_cppclass_main.cpp
MAKEFILE             = acc.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = acc_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\acc_rtmaps_build
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
