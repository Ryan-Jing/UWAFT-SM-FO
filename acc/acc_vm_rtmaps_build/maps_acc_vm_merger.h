#ifndef maps_acc_vm_merger_h_
#define maps_acc_vm_merger_h_
#ifdef _MSC_VER
#if _MSC_VER < 1900
...
#define ComponentClass                 maps_acc_vm_merger
#define ComponentName                  "acc_vm_merger"
...
class ComponentClass : public MAPSComponent
{
 ...
 private:
  ...
  const acc_vm_rtmaps_tlc_types::Struct* m_outputStruct = nullptr;
