...
MODEL                = acc_vm
MODULES              = acc_vm_rtmaps_tlc_types.cpp maps_acc_vm.cpp maps_acc_vm_merger.cpp maps_acc_vm_splitter.cpp rt_cppclass_main.cpp
MAKEFILE             = acc_vm.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\Users\ryanj\Projects\UWAFT-SM-FO\acc
S_FUNCTIONS          = 
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = acc_vm_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\acc_vm_rtmaps_build
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
