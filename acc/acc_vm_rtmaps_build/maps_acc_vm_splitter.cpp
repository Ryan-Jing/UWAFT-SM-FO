#include "maps_acc_vm_splitter.h"
#include <algorithm>
#include <cstring>
#include <type_traits>
...
{
  DirectSet(Property(P_IDX_INPUT_TYPES), acc_vm_rtmaps_tlc_helper::
  ...
  m_inputStruct = & acc_vm_rtmaps_tlc_types::getStruct(m_input_type);
...
template <typename TDataType>
  ...
  (MAPSOutput* output, const acc_vm_rtmaps_tlc_types::Field& field)
{
  return {
    output,
    field,
...
ComponentClass::OutputWrapper ComponentClass::makeStructOutputWrapper(MAPSOutput*
  output, const acc_vm_rtmaps_tlc_types::Field& field)
{
  return {
    output,
    field,
...
ComponentClass::OutputWrapper ComponentClass::createOutput(const
  acc_vm_rtmaps_tlc_types::Field& field)
{
