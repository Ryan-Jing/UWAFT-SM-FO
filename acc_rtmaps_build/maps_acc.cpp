...
void ComponentClass::computeSkModelInputs()
{
        ...
        size_t elementCount)
  {
    ...
    using data_pointer_type =
      ...
      typename std::remove_pointer<
      typename std::decay<
      decltype( &acc_U.Current_State_Bus )
      >::type
      >::type
      >::type
      >::type
...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_acc_T &acc_Y = acc_Obj.getExternalOutputs();
  m_skModelOutputs.emplace_back(
    ...
    SkTypeId::t_struct,
    "StatusType",
    static_cast<int>(sizeof( StatusType )),
    &acc_Y.ACCCurrentState,
    [] (const TypeID_Value mapsTypeId, void* mapsOutPtr, const void *data, const
        size_t elementCount)
  {
    copyData(
             mapsTypeId,
             static_cast<const StatusType*>(data),
             mapsOutPtr,
             elementCount
             );
  }
...
{
  acc_Obj.setExternalInputs(&acc_U);
  acc_Obj.step();
}
