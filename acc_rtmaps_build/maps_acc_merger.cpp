...
{
  DirectSet(Property(P_IDX_OUTPUT_TYPES), acc_rtmaps_tlc_helper::
  ...
  m_outputStruct = & acc_rtmaps_tlc_types::getStruct(output_type);
  if (m_outputStruct == nullptr) {
...
template <typename TField_ActualType>
  ...
  const acc_rtmaps_tlc_types::Field& field)
{
