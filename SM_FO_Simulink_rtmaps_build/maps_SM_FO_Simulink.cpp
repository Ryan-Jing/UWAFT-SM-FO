...
void ComponentClass::computeSkModelOutputs()
{
  ...
  const ExtY_SM_FO_Simulink_T &SM_FO_Simulink_Y =
    SM_FO_Simulink_Obj.getExternalOutputs();
...
{
  SM_FO_Simulink_Obj.initialize();
}

void ComponentClass::doSkModelStep()
{
  SM_FO_Simulink_Obj.setExternalInputs(&SM_FO_Simulink_U);
  SM_FO_Simulink_Obj.step();
}

void ComponentClass::terminateSkModel()
{
  SM_FO_Simulink_Obj.terminate();
}
